...
- **Ne pas construire** : inscription publique, HA/réplication/PITR, YunoHost/Coolify/CasaOS/boutons cloud/managé, code ETL SP-15 (spec §9) — hors périmètre de ce sous-plan comme des trois autres.
