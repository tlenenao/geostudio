...
def _register_incidents_collection_owned_by_other(app_client):
    ...
    with app_client.session_factory() as session:
        ...
        other_owner = get_or_create_user(
            session, tenant_id=app_client.tenant.id, oidc_sub="other-owner-raq-collection-sub",
            username="otherowner-raq-collection", email=None, first_name="Other", last_name="Owner",
        )
        ...
        col = collections_repo.create_collection(
            session, tenant_id=app_client.tenant.id, owner_id=other_owner.id,
