...
const layout: AppLayout = {
  type: "grid",
  breakpoints: {},
  items: [{ id: "a1", widget: "text", x: 0, y: 0, w: 2, h: 2, props: {} }],
};
...
test("getPages returns the explicit pages array when present", () => {
  const pages = [
    { id: "p1", name: "Accueil", layout },
    { id: "p2", name: "Détails", layout },
  ];
...
test("getPageLayout resolves the matching page's layout", () => {
  ...
  const pages = [
    { id: "p1", name: "Accueil", layout },
    { id: "p2", name: "Détails", layout: otherLayout },
  ];
...
test("setPageLayout on an explicit-pages config updates only the matching page and mirrors pages[0] into layout", () => {
  ...
  const newLayout: AppLayout = {
    type: "grid",
    breakpoints: {},
    items: [{ id: "z", widget: "text", x: 1, y: 1, w: 1, h: 1, props: {} }],
  };
